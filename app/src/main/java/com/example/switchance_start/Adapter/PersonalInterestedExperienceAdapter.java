...
import com.example.switchance_start.register.InterestedExperienceAdapter;

import java.util.ArrayList;

public class PersonalInterestedExperienceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    ArrayList interestedExperienceList;
    Context mContext;

    public PersonalInterestedExperienceAdapter(Context context) {
        mContext = context;
    ...
    @NonNull
    @Override
    public PersonalInterestedExperienceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.recycler_view_owned_personal_experience, parent, false);
        return new PersonalInterestedExperienceAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        InterestedExperience experience = (InterestedExperience) interestedExperienceList.get(position);
        ((PersonalInterestedExperienceAdapter.ViewHolder)holder).bindToInterestedExperience(experience);
    }
